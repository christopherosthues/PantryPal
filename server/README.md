...
| Path             | Description                                             |
| ------------------|--------------------------------------------------------- |
| [server](../server-old/server) | A runnable Ktor server implementation                   |
| [core](../server-old/core)     | Domain objects and interfaces                           |
| [client](../server-old/client) | Extensions for making requests to the server using Ktor |
