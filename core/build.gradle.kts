...
val generateNetworkingConstants = tasks.register("generateNetworkingConstants") {
    ...
    doLast {
        val file = outputDir.get().file("org/darthacheron/pantrypal/core/NetworkingConstants.kt").asFile
        file.parentFile.mkdirs()
        file.writeText(
            """
            package org.darthacheron.pantrypal.core
...
kotlin {
    ...
    android {
        namespace = "org.darthacheron.pantrypal.core"
        compileSdk {
            version = release(36) {
                minorApiLevel = 1
            }
